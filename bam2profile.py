...
bam2bw + bw2matrix + matrix2profile
"""
...
class Bam2profile(object):
    ...
    def init_files(self):
        ...
        for d in [self.bw_dir, self.matrix_dir, self.profile_dir]:
    ...
    def bam2profile_ss(self):
        ...
        # 4. copy files
        symlink_file(r3.profile_file, self.profile_file_sens)
        symlink_file(r4.profile_file, self.profile_file_anti)        
